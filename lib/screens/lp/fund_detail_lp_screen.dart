        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              onChanged: (text) {
                setState(() {
                  // cost = (stockCountController.text as int) * widget.fund.costPerShare;
                  print(widget.stockCountController.text);
                  cost = (int.parse(widget.stockCountController.text)) * 1000;
                  print(cost);
                });
              },
            ),
