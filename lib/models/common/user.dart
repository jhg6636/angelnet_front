...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
        ...
        lastLoginAt: DateTime(json['lastLoginAt'][0], json['lastLoginAt'][1], json['lastLoginAt'][2], json['lastLoginAt'][3], json['lastLoginAt'][4], json['lastLoginAt'][5]),
    );
  }
            ...
            Container(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Get.to(
                    ScreenFrameV2(
                      main: MakeUserForm(isAdmin: true, isEditing: true, user: this),
                      isAdmin: true,
